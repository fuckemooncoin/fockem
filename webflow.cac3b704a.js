...
, function(t, e, n) {
    ...
    ;
    var _, g = navigator.userAgent.toLowerCase(), y = r.env.touch = "ontouchstart"in window || window.DocumentTouch && document instanceof window.DocumentTouch, m = r.env.chrome = /chrome/.test(g) && /Google/.test(navigator.vendor) && parseInt(g.match(/chrome\/(\d+)\./)[1], 10), I = r.env.ios = /(ipod|iphone|ipad)/.test(g);
...
, function(t, e, n) {
    ...
    function _t(t) {
        var e, n = t.store, r = t.eventId, i = t.eventTarget, o = t.eventStateKey, a = t.actionListId, u = t.groupIndex, c = void 0 === u ? 0 : u, f = t.immediate, l = t.verbose, d = n.getState(), p = d.ixData, v = d.ixSession, h = p.events[r] || {}, E = h.mediaQueries, _ = void 0 === E ? p.mediaQueryKeys : E, g = (0,
        s.default)(p, "actionLists.".concat(a), {}), y = g.actionItemGroups, I = g.useFirstGroupAsInitialState;
        if (!y || !y.length)
            return !1;
        c >= y.length && (0,
    ...
    t.exports = function(t, e, n, a, u, c) {
        ...
        for (var _ = s; ++d < l; ) {
            var g = t[p = f[d]]
              , y = e[p];
            if (a)
                var m = s ? a(y, g, p, e, t, c) : a(g, y, p, t, e, c);
...
, function(t, e, n) {
            ...
            return function(t, e, n, r, i, o) {
                ...
                case ut:
                    var _ = lt[u]
                      ...
                      , I = n.aValue;
                    Nt(t, _, o),
                    a(t, _, I >= 1 ? "rgb(".concat(g, ",").concat(y, ",").concat(m, ")") : "rgba(".concat(g, ",").concat(y, ",").concat(m, ",").concat(I, ")"));
                    break;
                default:
                    var T = c.unit
                      , O = void 0 === T ? "" : T;
    ...
    r))
      , dt = Object.freeze((i = {},
    (0,
    c.default)(i, g.TRANSFORM_PREFIXED, I),
    (0,
    c.default)(i, P, m),
    (0,
    c.default)(i, x, x),
    ...
    function gt(t) {
        ...
        var N, x, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[T || b] || {}, D = Boolean(L.id || L.selector), P = o && l(_t(o.target));
        ...
        return null == x || null == C ? [] : g.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : N === F ? d(x, C) : N === G ? p(d(x)).filter(E(C)) : N === X ? v(d(x)).filter(E(C)) : d(C)
    }
    var yt = /px/
      , mt = function(t, e) {
...
, function(t, e, n) {
    ...
    var r = n(2)
      ...
      , T = function(t, e) {
        ...
        null == p && (d = 1,
        p = c);
        var E, _, g, m, I = Math.max(p, 0) || 0, T = v(I - n), O = v(n + T * d), b = 100 * O;
        if (O === n && t.current)
            return t;
...
, function(t, e, n) {
    ...
    e.default = void 0;
    var c, s, f, l = u(n(27)), d = u(n(294)), p = u(n(55)), v = u(n(313)), h = n(2), E = n(114), _ = n(60), g = n(10), y = h.EventTypeConsts, m = y.MOUSE_CLICK, I = y.MOUSE_SECOND_CLICK, T = y.MOUSE_DOWN, O = y.MOUSE_UP, b = y.MOUSE_OVER, w = y.MOUSE_OUT, A = y.DROPDOWN_CLOSE, S = y.DROPDOWN_OPEN, R = y.SLIDER_ACTIVE, N = y.SLIDER_INACTIVE, x = y.TAB_ACTIVE, C = y.TAB_INACTIVE, L = y.NAVBAR_CLOSE, D = y.NAVBAR_OPEN, P = y.MOUSE_MOVE, M = y.PAGE_SCROLL_DOWN, j = y.SCROLL_INTO_VIEW, F = y.SCROLL_OUT_OF_VIEW, G = y.PAGE_SCROLL_UP, X = y.SCROLLING_IN_VIEW, k = y.PAGE_FINISH, V = y.ECOMMERCE_CART_CLOSE, U = y.ECOMMERCE_CART_OPEN, W = y.PAGE_START, B = y.PAGE_SCROLL, H = "COMPONENT_ACTIVE", z = "COMPONENT_INACTIVE", Y = h.IX2EngineConstants.COLON_DELIMITER, K = g.IX2VanillaUtils.getNamespacedParameterId, Q = function(t) {
        return function(e) {
            return !("object" !== (0,
            a.default)(e) || !t(e)) || e
        }
    ...
    r.define("scroll", t.exports = function(t) {
        ...
        function h(e) {
            ...
            if (!(r.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                var s, l = (s = a,
                p.test(s.hash) && s.host + s.pathname === n.host + n.pathname ? a.hash : "");
                if ("" !== l) {
                    var d = t(l);
...
, function(t, e, n) {
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function m(e, n) {
            ...
            g.test(u) ? i.handler = w : u || (o ? i.handler = b : y())
        }
        function I(t) {
...
, function(t, e, n) {
    ...
    r.define("navbar", t.exports = function(t, e) {
        var n, a, u, c, s = {}, f = t.tram, l = t(window), d = t(document), p = e.debounce, v = r.env(), h = '<div class="w-nav-overlay" data-wf-ignore />', E = ".w-nav", _ = "w--open", g = "w--nav-dropdown-open", y = "w--nav-dropdown-toggle-open", m = "w--nav-dropdown-list-open", I = "w--nav-link-open", T = i.triggers, O = t();
        function b() {
            r.resize.off(w)
        }
        function w() {
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|a5020f53-3503-b2bc-83e2-377fc89ea33b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-3": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|8c9d6b84-1442-e55b-622f-7c015bdb8ff3",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|4258dd74-2002-be45-45ca-6f6112337716",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-7": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|2d04401a-73b5-81b8-0cf6-8a61f31a38ea",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-9": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|53480989-33f6-fd14-e08d-be54ad41acac",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-11": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|210b2c92-6827-c6d0-64ef-0e99c5b8336c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-13": {
            ...
            "action": {
                ...
                "instant": false,
                "config": {
                    "actionListId": "flyInLeft",
                    "autoStopEventId": "e-14"
                }
            },
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|a6c50144-204e-3011-3235-a4bcff6bf9cb",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-15": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|7c365e11-1452-be3b-1e0d-31fabfc85bf3",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-17": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|c95cc710-ec8a-9aea-35f0-5d5e382740fd",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-19": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|845ba980-31b0-3e52-02fe-bde2c437b691",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-21": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|f457fc33-8abb-42fd-c9fa-73d1c1108631",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-23": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|755256bb-27ea-df53-36b3-779e18642107",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-25": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|793c8311-c0eb-fcb2-4e3a-61b39924ced1",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-27": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|0f9cf7dc-d4a5-5d83-4efa-b025a4650990",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-29": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|26eeabd5-d47a-2125-59e3-0b8a2a6cf844",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-31": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|f1a0ac39-e1a6-acdb-5cc8-35b79c291824",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-33": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "60a56f1bbafa1f6061fa7196|78310e01-c352-b07a-4716-3568e69d011f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [],

!function e(t, r, n) {
    ...
    3: [function(e, t, r) {
        ...
        class g extends u.default {
            constructor(e, {jsonRpcStreamName: t="metamask-provider", logger: r=console, maxEventListeners: n=100, shouldSendMetadata: u=!0}={}) {
                if (!f.duplex(e))
                    throw new Error(d.default.errors.invalidDuplexStream());
                if ("number" != typeof n || "boolean" != typeof u)
                    throw new Error(d.default.errors.invalidOptions(n, u));
                !function(e) {
                    if (e !== console) {
                        if ("object" == typeof e) {
                            ...
                            for (const r of t)
                                if ("function" != typeof e[r])
                                    throw new Error(d.default.errors.invalidLoggerMethod(r));
                            return
                        }
                ...
                i.default(e, c, e, this._handleStreamDisconnect.bind(this, "MetaMask")),
                c.ignoreStream("phishing"),
                this.on("connect", ()=>{
                ...
                if (g.push(o.createIdRemapMiddleware()),
                g.push(p.createErrorMiddleware(this._log)),
                g.push(l.middleware),
                this._rpcEngine = g,
                this._initializeState(),
                l.events.on("notification", t=>{
                    const {method: r, params: n} = t;
                    "metamask_accountsChanged" === r ? this._handleAccountsChanged(n) : "metamask_unlockStateChanged" === r ? this._handleUnlockStateChanged(n) : "metamask_chainChanged" === r ? this._handleChainChanged(n) : p.EMITTED_NOTIFICATIONS.includes(r) ? (this.emit("data", t),
                    this.emit("message", {
                        type: r,
                        data: n
                    }),
                ...
                u)
                    if ("complete" === document.readyState)
                        h.default(this._rpcEngine, this._log);
                    else {
                        const e = ()=>{
                            h.default(this._rpcEngine, this._log),
            ...
            _handleDisconnect(e, t) {
                if (this._state.isConnected || !this._state.isPermanentlyDisconnected && !e) {
                    ...
                    e ? (r = new l.EthereumRpcError(1013,t || d.default.errors.disconnected()),
                    this._log.debug(r)) : (r = new l.EthereumRpcError(1011,t || d.default.errors.permanentlyDisconnected()),
                    this._log.error(r),
                    this.chainId = null,
                    this.networkVersion = null,
            ...
            _handleStreamDisconnect(e, t) {
                p.logStreamDisconnectWarning(this._log, e, t, this),
                this._handleDisconnect(!1, t ? t.message : void 0)
            }
            _handleChainChanged({chainId: e, networkVersion: t}={}) {
                e && "string" == typeof e && e.startsWith("0x") && t && "string" == typeof t ? "loading" === t ? this._handleDisconnect(!0) : (this._handleConnect(e),
                e !== this.chainId && (this.chainId = e,
                this._state.initialized && this.emit("chainChanged", this.chainId)),
                t !== this.networkVersion && (this.networkVersion = t,
                this._state.initialized && this.emit("networkChanged", this.networkVersion))) : this._log.error("MetaMask: Received invalid network parameters. Please report this bug.", {
                    chainId: e,
                    networkVersion: t
                })
            }
            _handleAccountsChanged(e, t=!1) {
                ...
                c.default(this._state.accounts, r) || (t && null !== this._state.accounts && this._log.error("MetaMask: 'eth_accounts' unexpectedly updated accounts. Please report this bug.", r),
            ...
            _warnOfDeprecation(e) {
                !1 === this._state.sentWarnings.events[e] && (this._log.warn(d.default.warnings.events[e]),
            ...
            _getExperimentalApi() {
                return new Proxy({
                    ...
                    get: (e,t,...r)=>(this._state.sentWarnings.experimentalMethods || (this._log.warn(d.default.warnings.experimentalMethods),
                    this._state.sentWarnings.experimentalMethods = !0),
                    Reflect.get(e, t, ...r))
                })
            }
            enable() {
                return this._state.sentWarnings.enable || (this._log.warn(d.default.warnings.enableDeprecation),
            ...
            send(e, t) {
                return this._state.sentWarnings.send || (this._log.warn(d.default.warnings.sendDeprecation),
    ...
    5: [function(e, t, r) {
        ...
        r.initializeProvider = function({connectionStream: e, jsonRpcStreamName: t, logger: r=console, maxEventListeners: n=100, shouldSendMetadata: a=!0, shouldSetOnWindow: u=!0, shouldShimWeb3: c=!1}) {
    ...
    9: [function(e, t, r) {
        ...
        r.NOOP = ()=>{}
        ,
        r.EMITTED_NOTIFICATIONS = ["eth_subscription"]
    }
    , {
        "eth-rpc-errors": 28
    }],
 ...
 */
        ...
        function a(e, t, r) {
            ...
            if (B(e, ArrayBuffer) || e && B(e.buffer, ArrayBuffer))
                return function(e, t, r) {
                    ...
                    return n.__proto__ = s.prototype,
                    n
                }(e, t, r);
            if ("number" == typeof e)
            ...
            var i = function(e) {
                ...
                if (void 0 !== e.length)
                    return "number" != typeof e.length || D(e.length) ? o(0) : l(e);
    ...
    22: [function(e, t, r) {
        ...
        s.prototype.prependOnceListener = function(e, t) {
            if ("function" != typeof t)
                throw new TypeError('"listener" argument must be a function');
            return this.prependListener(e, b(this, e, t)),
            this
        }
        ,
            ...
            var n = e("once")
              ...
              , o = function(e, t, s) {
                ...
                var a = e._writableState
                  ...
                  , b = function() {
                    if (!f)
                        return (!c || u && u.ended && !u.destroyed) && (!l || a && a.ended && !a.destroyed) ? void 0 : s.call(e, new Error("premature close"))
                }
                  , w = function() {
                    e.req.on("finish", h)
                };
    ...
    29: [function(e, t, r) {
        ...
        r.serializeError = function(e, {fallbackError: t=s, shouldIncludeStack: r=!1}={}) {
            ...
            if (e && "object" == typeof e && !Array.isArray(e) && f(e, "code") && u(e.code)) {
                const t = e;
                c.code = t.code,
                t.message && "string" == typeof t.message ? (c.message = t.message,
                f(t, "data") && (c.data = t.data)) : (c.message = a(c.code),
                c.data = {
                    originalError: l(e)
                })
            } else {
                ...
                c.message = r && "string" == typeof r ? r : t.message,
                c.data = {
                    originalError: l(e)
                }
            }
            const d = null === (o = e) || void 0 === o ? void 0 : o.stack;
            return r && e && d && "string" == typeof d && (c.stack = d),
            c
        }
    }
    , {
    ...
    42: [function(e, t, r) {
        !function(e, r) {
            ...
            function n(t) {
                ...
                "undefined" != typeof console && (void 0 !== console[t] ? r(console, t) : void 0 !== console.log ? r(console, "log") : e)
            }
            function i(r, n) {
            ...
            function o(e, t, r) {
                return function() {
                    "undefined" != typeof console && (i.call(this, t, r),
            ...
            function a(e, r, n) {
                        ...
                        if (void 0 === e)
                            try {
                                var t = window.document.cookie
                                  , r = t.indexOf(encodeURIComponent(u) + "=");
                ...
                a.setLevel = function(r, n) {
                    ...
                    i.call(a, r, e),
                    "undefined" == typeof console && r < a.levels.SILENT)
            ...
            u.getLogger = function(e) {
                ...
                var t = c[e];
                return t || (t = c[e] = new a(e,u.getLevel(),u.methodFactory)),
                t
            }
            ;
            var l = "undefined" != typeof window ? window.log : void 0;
            return u.noConflict = function() {
                return "undefined" != typeof window && window.log === u && (window.log = l),
                u
            }
            ,
        ...
        (function(r, n) {
            ...
            w.prototype.pipe = function(e, t) {
                ...
                function g(t) {
                    h("ondata"),
                    p = !1,
                    !1 !== e.write(t) || p || ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== T(o.pipes, e)) && !d && (h("false write response, pause", n._readableState.awaitDrain),
            ...
            w.prototype.on = function(e, t) {
                ...
                if ("data" === e)
                    ...
                    n.emittedReadable = !1,
                    n.reading ? n.length && S(this) : i.nextTick(j, this))
                }
                return r
            }
            ,
                ...
                if (e._writev && r && r.next) {
                    ...
                    for (; r; ) {
                        var c = r.chunk
                          , l = r.encoding
                          , f = r.callback;
                        if (w(e, t, !1, t.objectMode ? 1 : c.length, c, l, f),
                        r = r.next,
    ...
    63: [function(e, t, r) {
        (function(t, n) {
            ...
            function l(e, t, n) {
                ...
                E(t) && (s.indexOf("message") >= 0 || s.indexOf("description") >= 0))
                    return f(t);
                if (0 === s.length) {
                    if (S(t)) {
                        var u = t.name ? ": " + t.name : "";
                ...
                (h(t) && (M = !0,
                k = ["[", "]"]),
                S(t)) && (v = " [Function" + (t.name ? ": " + t.name : "") + "]");
                return w(t) && (v = " " + RegExp.prototype.toString.call(t)),
                _(t) && (v = " " + Date.prototype.toUTCString.call(t)),
                E(t) && (v = " " + f(t)),
                0 !== s.length || M && 0 != t.length ? n < 0 ? w(t) ? e.stylize(RegExp.prototype.toString.call(t), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(t),
                c = M ? function(e, t, r, n, i) {
                    for (var o = [], s = 0, a = t.length; s < a; ++s)
                        R(t, String(s)) ? o.push(d(e, t, r, n, String(s), !0)) : o.push("");
            ...
            function d(e, t, r, n, i, o) {
                ...
                R(n, i) || (s = "[" + i + "]"),
                a || (e.seen.indexOf(u.value) < 0 ? (a = g(r) ? l(e, u.value, null) : l(e, u.value, r - 1)).indexOf("\n") > -1 && (a = o ? a.split("\n").map((function(e) {
                    return "  " + e
                }
                )).join("\n").substr(2) : "\n" + a.split("\n").map((function(e) {
                    return "   " + e
